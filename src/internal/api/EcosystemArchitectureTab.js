    ...
    <>
      ...
      <div className="block">
        ...
        <div className="eco-timeline">
          <div className="eco-timeline-item"><div className="eco-timeline-phase">Foundation</div><div className="eco-timeline-desc"><strong>Terra API</strong> — Centralized trust layer. Manages identity, webhooks, health monitoring, event bus, and billing primitives. All services authenticate here and emit state changes through unified events.</div></div>
      ...
      <div className="block">
        ...
        <div className="eco-grid-3">
          <div className="eco-card"><div className="eco-card-title">Phase 1</div><div className="eco-card-desc">Foundation + Dashboard. Terra API, ROMS, and PIOS core services deployed. Web dashboards for observability.</div></div>
